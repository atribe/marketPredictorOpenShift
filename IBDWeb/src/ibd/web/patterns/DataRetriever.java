...
public class DataRetriever{
	...
	private String shortCookie = "ibdSession=Webuserid=185690723951612&RolesUpdated=True&LogInFlag=1&SessionId=33194116-3311-4e15-ba5a-ca13080375e7&adTr=1&adTi=4&adHo=stocks,mutualfunds,etfs&adJo=owner&adAg=4";
	...
	public static Connection getConnection(){
		...
		try{
			...
			String dbURL = "jdbc:mysql://localhost:3306/moneytreeibd50";
			String username = "root";
			String password = "root";
	...
	private void setTop100()throws FileNotFoundException, IOException, URISyntaxException{
		String u = "http://research.investors.com/etables/IBD50XLS.aspx?tabView=IBD50&from=etables&columnsort1=ibd50rank&columnsorttype1=DESC&columnsort2=&columnsorttype2=DESC";
		//String u= "http://research.investors.com/etables/default.aspx/";
		URL url = new URL(u);
